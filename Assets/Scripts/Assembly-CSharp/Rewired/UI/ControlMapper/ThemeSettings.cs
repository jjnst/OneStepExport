...
namespace Rewired.UI.ControlMapper
{
	...
	public class ThemeSettings : ScriptableObject
	{
		...
		private void Apply(string themeClass, Selectable item)
		{
			if (!(item == null))
			{
				SelectableSettings_Base selectableSettings_Base;
				if (item as Button != null)
				{
					selectableSettings_Base = ((!(themeClass == "inputGridField")) ? _buttonSettings : _inputGridFieldSettings);
				}
				else if (item as Scrollbar != null)
				{
					selectableSettings_Base = _scrollbarSettings;
				}
				else if (item as Slider != null)
				{
					selectableSettings_Base = _sliderSettings;
				}
				else if (item as Toggle != null)
				{
					selectableSettings_Base = ((!(themeClass == "button")) ? _selectableSettings : _buttonSettings);
				}
				else
				{
					selectableSettings_Base = _selectableSettings;
				}
