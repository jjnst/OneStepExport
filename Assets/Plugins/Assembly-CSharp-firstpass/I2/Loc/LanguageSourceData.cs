...
namespace I2.Loc
{
	...
	public class LanguageSourceData
	{
		...
		public float GoogleUpdateDelay = 0f;
		...
		public void ApplyDownloadedDataFromGoogle()
		{
			...
			string value = Import_Google_Result(mDelayedGoogleData, eSpreadsheetUpdateMode.Replace, true);
		...
		public UnityWebRequest Import_Google_CreateWWWcall(bool ForceUpdate, bool justCheck)
		{
			...
			string uri = string.Format("{0}?key={1}&action=GetLanguageSource&version={2}", LocalizationManager.GetWebServiceURL(this), Google_SpreadsheetKey, ForceUpdate ? "0" : Google_LastUpdatedVersion);
		...
		public LanguageData GetLanguageData(string language, bool AllowDiscartingRegion = true)
		{
			...
			return (languageIndex < 0) ? null : mLanguages[languageIndex];
		}
		...
		{
			int num = (OnlyMainCategory ? FullTerm.IndexOfAny(CategorySeparators) : FullTerm.LastIndexOfAny(CategorySeparators));
			return (num < 0) ? EmptyCategory : FullTerm.Substring(0, num);
		}
