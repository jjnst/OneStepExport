...
namespace I2.Loc
{
	public static class GoogleLanguages
	{
		...
		public static ePluralType GetPluralType(string langCode, int n)
		{
			...
			default:
				...
				case 3:
				{
					...
					{
					default:
						result4 = ((inRange(n, 3, 10) || inRange(n, 13, 19)) ? 3 : 5);
						break;
					case 2:
					case 12:
						result4 = 2;
				...
				case 4:
					return (n == 1) ? ePluralType.One : (inRange(n % 100, 1, 19) ? ePluralType.Few : ePluralType.Plural);
				case 5:
					return (n % 10 == 1 && n % 100 != 11) ? ePluralType.One : ((n % 10 >= 2 && (n % 100 < 10 || n % 100 >= 20)) ? ePluralType.Few : ePluralType.Plural);
				case 6:
					return (n % 10 == 1 && n % 100 != 11) ? ePluralType.One : ((inRange(n % 10, 2, 4) && !inRange(n % 100, 12, 14)) ? ePluralType.Few : ePluralType.Plural);
				case 7:
					return (n == 1) ? ePluralType.One : (inRange(n, 2, 4) ? ePluralType.Few : ePluralType.Plural);
				case 8:
					return (n == 1) ? ePluralType.One : ((inRange(n % 10, 2, 4) && !inRange(n % 100, 12, 14)) ? ePluralType.Few : ePluralType.Plural);
				case 9:
					return (n % 100 == 1) ? ePluralType.One : ((n % 100 == 2) ? ePluralType.Two : (inRange(n % 100, 3, 4) ? ePluralType.Few : ePluralType.Plural));
				case 10:
				{
					int result2;
					switch (n)
					{
					default:
						result2 = (inRange(n, 3, 6) ? 3 : (inRange(n, 7, 10) ? 4 : 5));
						break;
					case 2:
						result2 = 2;
						break;
				...
				case 11:
				{
					...
					{
					default:
						result3 = (inRange(n % 100, 3, 10) ? 3 : ((n % 100 >= 11) ? 4 : 5));
						break;
					case 2:
						result3 = 2;
						break;
				...
				case 12:
					return (n == 1) ? ePluralType.One : (inRange(n % 100, 1, 10) ? ePluralType.Few : (inRange(n % 100, 11, 19) ? ePluralType.Many : ePluralType.Plural));
				case 13:
					return (n % 10 == 1) ? ePluralType.One : ((n % 10 == 2) ? ePluralType.Two : ePluralType.Plural);
				case 14:
					return (n % 10 == 1 && n % 100 != 11) ? ePluralType.One : ePluralType.Plural;
				case 15:
					return (n % 10 == 1 && n % 100 != 11 && n % 100 != 71 && n % 100 != 91) ? ePluralType.One : ((n % 10 == 2 && n % 100 != 12 && n % 100 != 72 && n % 100 != 92) ? ePluralType.Two : (((n % 10 == 3 || n % 10 == 4 || n % 10 == 9) && n % 100 != 13 && n % 100 != 14 && n % 100 != 19 && n % 100 != 73 && n % 100 != 74 && n % 100 != 79 && n % 100 != 93 && n % 100 != 94 && n % 100 != 99) ? ePluralType.Few : ((n % 1000000 == 0) ? ePluralType.Many : ePluralType.Plural)));
				case 16:
				{
					int result;
					switch (n)
		...
		public static int GetPluralTestNumber(string langCode, ePluralType pluralType)
		{
			...
			{
				int pluralRule = GetPluralRule(langCode);
				switch (pluralRule)
				{
				case 10:
					return 8;
