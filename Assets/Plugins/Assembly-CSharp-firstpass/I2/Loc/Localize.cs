...
namespace I2.Loc
{
	...
	public class Localize : MonoBehaviour
	{
		...
		public TermModification SecondaryTermModifier = TermModification.DontModify;
		...
		public bool IgnoreRTL = false;

		public int MaxCharactersInRTL = 0;
		...
		public bool AlwaysForceLocalize = false;
		...
		public string GetMainTargetsText()
		{
			...
			return string.IsNullOrEmpty(primaryTerm) ? mTerm : primaryTerm;
		}
		...
		public T FindTranslatedObject<T>(string value) where T : UnityEngine.Object
		{
			...
			Debug.Log(base.transform.name + " " + base.transform.parent.name + " " + base.transform.parent.parent.name);
