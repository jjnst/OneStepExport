...
namespace MoonSharp.Interpreter.CoreLib
{
	...
	public class MathModule
	{
		...
		{
			DynValue dynValue = s.Registry.Get("F61E3AA7247D4D1EB7A45430B0C8C9BB_MATH_RANDOM");
			return (dynValue.UserData.Object as AnonWrapper<Random>).Value;
		}
		...
		{
			DynValue dynValue = args.AsType(0, "frexp", DataType.Number);
		...
		public static DynValue randomseed(ScriptExecutionContext executionContext, CallbackArguments args)
		{
			...
			SetRandom(script, new Random((int)dynValue.Number));
			return DynValue.Nil;
		}
