Shader "Shadero Customs/CardtridgeOverlay" {
	Properties {
		[PerRendererData] _MainTex ("Sprite Texture", 2D) = "white" {}
		_TintRGBA_Color_1 ("_TintRGBA_Color_1", Vector) = (0.2156863,0.6,0.8509804,1)
		_FillColor_Color_1 ("_FillColor_Color_1", Vector) = (0.2156863,0.6,0.8509804,0.2941177)
